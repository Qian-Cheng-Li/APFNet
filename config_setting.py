...
class setting_config:
    ...
    if datasets == 'NRSD-MN':
        data_path = ''
    elif datasets == 'NEU RSDDS-AUG':
        data_path = ''
    elif datasets == 'Crack500':
        data_path = ''
    elif datasets == 'IPSS':
        data_path = ''
    elif datasets == 'ISAEB':
    ...
    # pretrained_path = 'D:\\python_rtobdt\\LB-UNet\\LB-UNet-main\\pretrained'
    num_classes = 1
    input_size_h = 352
    input_size_w = 352
    input_channels = 3
    ...
    if opt == 'Adadelta':
        ...
        betas = (0.9, 0.999) # default: (0.9, 0.999) – coefficients used for computing running averages of gradient and its square
        eps = 1e-8 # default: 1e-8 – term added to the denominator to improve numerical stability
        weight_decay = 0.001 # default: 1e-2 – weight decay coefficient
        amsgrad = False # default: False – whether to use the AMSGrad variant of this algorithm from the paper On the Convergence of Adam and Beyond 
    elif opt == 'Adamax':
    ...
    if sch == 'StepLR':
        ...
        # T_max = 78000 # – Maximum number of iterations. Cosine function period.
        # eta_min = 0.000001 # – Minimum learning rate. Default: 0.
        # last_epoch = -1 # – The index of last epoch. Default: -1.

        # T_max = 56100  # – Maximum number of iterations. Cosine function period.
        # eta_min = 0.000001  # – Minimum learning rate. Default: 0.
        # last_epoch = -1  # – The index of last epoch. Default: -1.

        T_max = 56250  # – Maximum number of iterations. Cosine function period.
        eta_min = 0.000001  # – Minimum learning rate. Default: 0.
        last_epoch = -1  # – The index of last epoch. Default: -1.

        # T_max = 71100  # – Maximum number of iterations. Cosine function period.
        # eta_min = 0.000001  # – Minimum learning rate. Default: 0.
        # last_epoch = -1  # – The index of last epoch. Default: -1.

        # T_max = 60000  # – Maximum number of iterations. Cosine function period.
        # eta_min = 0.000001  # – Minimum learning rate. Default: 0.
        # last_epoch = -1  # – The index of last epoch. Default: -1.

        # T_max = 132000  # – Maximum number of iterations. Cosine function period.
        # eta_min = 0.000001  # – Minimum learning rate. Default: 0.
        # last_epoch = -1  # – The index of last epoch. Default: -1.

        # T_max = 78150  # – Maximum number of iterations. Cosine function period.
        # eta_min = 0.000001  # – Minimum learning rate. Default: 0.
        # last_epoch = -1  # – The index of last epoch. Default: -1.

        # T_max = 78225  # – Maximum number of iterations. Cosine function period.
        # eta_min = 0.000001  # – Minimum learning rate. Default: 0.
        # last_epoch = -1  # – The index of last epoch. Default: -1.
